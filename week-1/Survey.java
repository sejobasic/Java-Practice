...
public class Survey {
    public static void main(String[] args) {
        ...
        double totalCoffeePrice = coffeeAmount * coffeePrice;
        double totalFoodPrice = foodAmount * foodPrice;

        scanner.close();
        //*********PART B: RESPONDING TO THE USER**********
        System.out.println("Thank you "+ name +" for answering all "+ counter +" questions");
        System.out.println("Weekly, you spend "+ totalCoffeePrice +" on coffee");
        System.out.println("Weekly, you spend "+ totalFoodPrice +" on food");
